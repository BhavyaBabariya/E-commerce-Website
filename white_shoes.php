...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="img/shoes4.jpg" width="90%" id="ProductImg">
			<div class="small-img-row">
				<div class="small-img-col">
					<img src="img/white1.webp" width="94%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/white2.webp" width="100%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/shoes4.jpg" width="89%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/white4.webp" width="102%" class="small-img">
				</div>
			</div>
		</div>
		<div class="col-2">
			...
			<br>
			<p>Kwik FIT casual sneaker shoes and partywear shoes Casuals For Men Sneakers For Men.(White)</p>
		</div>
	</div>
</div>
   <!-------title------------>
