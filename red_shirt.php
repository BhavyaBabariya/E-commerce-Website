...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="img/red2.jpg" width="100%" id="ProductImg">
			<div class="small-img-row">
				<div class="small-img-col">
					<img src="img/red2.jpg" width="90%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/red2.jpg" width="90%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/red3.jpg" width="80%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/red4.jpg" width="115%" class="small-img">
				</div>
			</div>
		</div>
		<div class="col-2">
			...
			<br>
			<p>YTD Mens 100% Cotton Casual Slim Fit Long Sleeve Button Down Printed Dress Shirts</p>
		</div>
	</div>
</div>
   <!-------title------------>
