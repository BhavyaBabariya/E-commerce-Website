...
<div class="small-container single-product">
	<div class="row">
		<div class="col-2">
			<img src="img/green3.jpg" width="100%" id="ProductImg">
			<div class="small-img-row">
				<div class="small-img-col">
					<img src="img/green3.jpg" width="90%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/green1.jpg" width="90%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/green2.jfif" width="90%" class="small-img">
				</div>
				<div class="small-img-col">
					<img src="img/green4.jpg" width="95%" class="small-img">
				</div>
			</div>
		</div>
		<div class="col-2">
			<p>Home / Shirt</p>
			<h1>Green Printed Shirt</h1>
			<h4>950₹</h4>
			<select>
			...
			<br><p>Specifications:
            Slim fit design, office style.
            This shirt features button-front, lapel collor and long sleeves.
            Wearing it, your husband or boyfriend will go from the boardroom to dinner party with ease.
